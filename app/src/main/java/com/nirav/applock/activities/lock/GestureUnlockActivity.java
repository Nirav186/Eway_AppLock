                ...
                if (mLockPatternUtils.checkPattern(pattern)) { //
                    ...
                    if (pattern.size() >= LockPatternUtils.MIN_PATTERN_REGISTER_FAIL) {
                        ...
                        if (retry >= 0) {
                            ...
                            if (SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(GestureUnlockActivity.this)) {
                            } else {
                                Constant.StartCameraService(GestureUnlockActivity.this);
                            }
                        }
                    } else {
