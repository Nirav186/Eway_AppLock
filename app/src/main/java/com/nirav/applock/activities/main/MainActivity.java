...
import com.nirav.applock.mvp.contract.LockMainContract;
...
import com.nirav.applock.widget.DialogSearch;
...
public class MainActivity extends BaseActivity implements LockMainContract.View, View.OnClickListener {
    ...
    protected void initAction() {
        ...
        mDialogSearch.setOnDismissListener(dialogInterface -> mLockMainPresenter.loadAppInfo(MainActivity.this));
