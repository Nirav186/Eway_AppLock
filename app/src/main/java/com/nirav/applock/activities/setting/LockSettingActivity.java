package com.nirav.applock.activities.setting;
...
import com.nirav.applock.activities.about.AboutMeActivity;
import com.nirav.applock.activities.lock.GestureCreateActivity;
...
import com.nirav.applock.model.LockAutoTime;
...
import com.nirav.applock.widget.SelectLockTimeDialog;
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean b) {
        switch (buttonView.getId()) {
            ...
            case R.id.checkbox_intruder_selfie:
                ...
                if (b){
                    Constant.StartCameraService(LockSettingActivity.this);
                }else {
                    Intent front_translucent = new Intent(this, CamerSelfiService.class);
                    stopService(front_translucent);
                }
                break;
