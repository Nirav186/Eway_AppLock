package com.nirav.applock.base;
...
public class AppConstants {
    ...
    public static final String LOCK_FROM_LOCK_HOME_ACITVITY = "lock_from_lock_home_activity";
    public static final String LOCK_FROM_CHARGE_REMOVAL = "lock_from_charge_removal";
